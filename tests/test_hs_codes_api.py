...
class TestHSCodesSearch:
    ...
    def test_search_cacao(self):
        ...
        response = requests.get(
            f"{BASE_URL}/api/hs-codes/search", params={"q": "cacao", "language": "fr", "limit": 15}
        )
        assert response.status_code == 200
    ...
    def test_search_coffee_english(self):
        ...
        response = requests.get(
            f"{BASE_URL}/api/hs-codes/search", params={"q": "coffee", "language": "en", "limit": 10}
        )
        assert response.status_code == 200
    ...
    def test_search_poisson(self):
        ...
        response = requests.get(
            f"{BASE_URL}/api/hs-codes/search",
            params={"q": "poisson", "language": "fr", "limit": 10},
        )
        assert response.status_code == 200
    ...
    def test_search_by_code(self):
        ...
        response = requests.get(
            f"{BASE_URL}/api/hs-codes/search", params={"q": "0901", "language": "fr", "limit": 10}
        )
        assert response.status_code == 200
    ...
    def test_search_minimum_length(self):
        ...
        response = requests.get(
            f"{BASE_URL}/api/hs-codes/search", params={"q": "a", "language": "fr"}
        )
    ...
    def test_search_limit_parameter(self):
        ...
        response = requests.get(
            f"{BASE_URL}/api/hs-codes/search", params={"q": "huile", "language": "fr", "limit": 5}
        )
        assert response.status_code == 200
...
class TestHSCodesChapterCodes:
    ...
    def test_get_chapter_09_codes(self):
        ...
        response = requests.get(f"{BASE_URL}/api/hs-codes/chapter/09", params={"language": "fr"})
        assert response.status_code == 200
    ...
    def test_get_chapter_18_codes(self):
        ...
        response = requests.get(f"{BASE_URL}/api/hs-codes/chapter/18", params={"language": "fr"})
        assert response.status_code == 200
    ...
    def test_get_chapter_03_codes(self):
        ...
        response = requests.get(f"{BASE_URL}/api/hs-codes/chapter/03", params={"language": "fr"})
        assert response.status_code == 200
    ...
    def test_chapter_english_language(self):
        ...
        response = requests.get(f"{BASE_URL}/api/hs-codes/chapter/09", params={"language": "en"})
        assert response.status_code == 200
...
class TestHSCodesSingleCode:
    ...
    def test_get_code_180100(self):
        ...
        response = requests.get(f"{BASE_URL}/api/hs-codes/code/180100", params={"language": "fr"})
        assert response.status_code == 200
    ...
    def test_get_code_english(self):
        ...
        response = requests.get(f"{BASE_URL}/api/hs-codes/code/090111", params={"language": "en"})
        assert response.status_code == 200
...
class TestRulesOfOriginIntegration:
    ...
    def test_rules_for_cacao(self):
        ...
        response = requests.get(f"{BASE_URL}/api/rules-of-origin/180100", params={"lang": "fr"})
        assert response.status_code == 200
    ...
    def test_rules_for_coffee(self):
        ...
        response = requests.get(f"{BASE_URL}/api/rules-of-origin/090111", params={"lang": "fr"})
        assert response.status_code == 200
    ...
    def test_rules_for_fish(self):
        ...
        response = requests.get(f"{BASE_URL}/api/rules-of-origin/030110", params={"lang": "en"})
        assert response.status_code == 200
