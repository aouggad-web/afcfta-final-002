...
_INTENT_PATTERNS: list[tuple[re.Pattern[str], str]] = [
    ...
    (
        re.compile(r"\b(classify|classification|hs code|hs number|heading)\b", re.I),
        "classification",
    ),
    ...
    (
        re.compile(r"\b(regulation|rule|requirement|standard|certificate|permit)\b", re.I),
        "regulatory",
    ),
...
_HS_CODE_DB: list[dict[str, Any]] = [
    ...
    {
        "code": "6201",
        "description": "Men's overcoats, car coats, capes, cloaks and similar articles",
    },
    ...
    {
        "code": "8517",
        "description": "Telephone sets including smartphones; other apparatus for transmission",
    },
