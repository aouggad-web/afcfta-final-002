...
UMA_COUNTRY_CONFIGS: Dict[str, Dict[str, Any]] = {
    ...
    "EGY": {
        ...
        "tariff_bands": {
            ...
            "30%": ["04", "16", "17", "19", "20", "21", "42", "63", "65", "69", "70", "87", "94"],
    ...
    "TUN": {
        ...
        "special_zones": [
            {
                "name": "Zone Franche de Bizerte",
                "location": "Bizerte",
                "benefit": "Exonération DD, TVA, IS sur 10 ans",
            },
            {
                "name": "Parcs de Technologie de Sousse",
                "location": "Sousse",
