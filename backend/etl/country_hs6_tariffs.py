...
NGA_HS6_TARIFFS = {
    ...
    "180690": {
        "dd": 0.20,
        "description_fr": "Autres préparations cacao",
        "description_en": "Other cocoa preparations",
    },
    # CAFÉ
    "090111": {
        "dd": 0.05,
    ...
    "870331": {
        "dd": 0.35,
        "description_fr": "Véhicules diesel ≤1500cc",
        "description_en": "Diesel vehicles ≤1500cc",
    },
    "870332": {
        "dd": 0.35,
        "description_fr": "Véhicules diesel 1500-2500cc",
        "description_en": "Diesel vehicles 1500-2500cc",
    },
    "870333": {
        "dd": 0.35,
        "description_fr": "Véhicules diesel >2500cc",
        "description_en": "Diesel vehicles >2500cc",
    },
    "870421": {
        "dd": 0.20,
    ...
    "847141": {
        "dd": 0.05,
        "description_fr": "Autres ordinateurs",
        "description_en": "Other computers",
    },
    "851712": {
        "dd": 0.10,
...
CIV_HS6_TARIFFS = {
    ...
    "400122": {
        "dd": 0.05,
        "description_fr": "Caoutchouc naturel TSNR",
        "description_en": "Technically specified natural rubber",
    },
    # HUILE DE PALME
    "151110": {
        "dd": 0.10,
...
ZAF_HS6_TARIFFS = {
    ...
    "711019": {
        "dd": 0.00,
        "description_fr": "Platine mi-ouvré",
        "description_en": "Platinum, semi-manufactured",
    },
    # MINERAIS
    ...
    "080520": {
        "dd": 0.00,
        "description_fr": "Mandarines fraîches",
        "description_en": "Fresh mandarins",
    },
    "080540": {
        "dd": 0.00,
        "description_fr": "Pamplemousses frais",
        "description_en": "Fresh grapefruit",
    },
    # MACHINES
    "841510": {
        "dd": 0.00,
...
KEN_HS6_TARIFFS = {
    ...
    "060312": {
        "dd": 0.00,
        "description_fr": "Oeillets frais coupés",
        "description_en": "Fresh cut carnations",
    },
    "060314": {
        "dd": 0.00,
...
EGY_HS6_TARIFFS = {
    ...
    "520511": {
        "dd": 0.05,
        "description_fr": "Fils de coton simple",
        "description_en": "Single cotton yarn",
    },
    "520512": {
        "dd": 0.05,
        "description_fr": "Fils de coton peigné",
        "description_en": "Combed cotton yarn",
    },
...
GHA_HS6_TARIFFS = {
    ...
    "180620": {
        "dd": 0.20,
        "description_fr": "Chocolat en blocs",
        "description_en": "Chocolate blocks",
    },
    # OR
    "710812": {
        "dd": 0.00,
...
def search_country_hs6_tariffs(
    country_code: str, query: str, language: str = "fr", limit: int = 20
) -> list:
    """
...
def get_available_country_tariffs() -> Dict:
    ...
    """
    return {
        iso3: {"count": len(tariffs), "chapters": list(set(code[:2] for code in tariffs.keys()))}
