...
ISO3_FR_NAME: Dict[str, str] = {
    ...
    "BFA": "Burkina Faso", "BDI": "Burundi", "CPV": "Cap-Vert", "CMR": "Cameroun",
    "CAF": "République centrafricaine", "TCD": "Tchad", "COM": "Comores",
    "COG": "Congo", "CIV": "Côte d'Ivoire", "COD": "RD Congo", "DJI": "Djibouti",
    "EGY": "Égypte", "GNQ": "Guinée équatoriale", "ERI": "Érythrée",
    "SWZ": "Eswatini", "ETH": "Éthiopie", "GAB": "Gabon", "GMB": "Gambie",
    "GHA": "Ghana", "GIN": "Guinée", "GNB": "Guinée-Bissau", "KEN": "Kenya",
    "LSO": "Lesotho", "LBR": "Libéria", "LBY": "Libye", "MDG": "Madagascar",
    "MWI": "Malawi", "MLI": "Mali", "MRT": "Mauritanie", "MUS": "Maurice",
    "MAR": "Maroc", "MOZ": "Mozambique", "NAM": "Namibie", "NER": "Niger",
    "NGA": "Nigéria", "RWA": "Rwanda", "STP": "Sao Tomé-et-Príncipe",
    "SEN": "Sénégal", "SYC": "Seychelles", "SLE": "Sierra Leone", "SOM": "Somalie",
    "ZAF": "Afrique du Sud", "SSD": "Soudan du Sud", "SDN": "Soudan",
...
MINING_EXTENDED: Dict[str, Tuple] = {
    # ── Métaux de base ────────────────────────────────────────────────────
    "Zinc": (
        "tonnes", _USGS, _USGS_MCS25, _USGS_URL,
        {
...
MINING_YEAR_2024: Dict[str, Tuple] = {
    "Gold": (
        "tonnes", _USGS, _USGS_MCS25, _USGS_URL,
        {
            "GHA": {2024: 135.0}, "MLI": {2024: 100.0}, "ZAF": {2024: 100.0},
            "BFA": {2024: 90.0}, "SDN": {2024: 60.0}, "GIN": {2024: 62.0},
            "TZA": {2024: 55.0}, "CIV": {2024: 55.0}, "COD": {2024: 46.0},
            "ZWE": {2024: 32.0}, "EGY": {2024: 17.0}, "SEN": {2024: 17.0},
            "ERI": {2024: 15.0}, "MRT": {2024: 15.0}, "NER": {2024: 12.0},
            "UGA": {2024: 5.0}, "ETH": {2024: 4.0},
        },
    ),
    "Copper": (
        "tonnes", _USGS, _USGS_MCS25, _USGS_URL,
        {
            "COD": {2024: 3300000.0}, "ZMB": {2024: 820000.0},
            "ZAF": {2024: 72000.0}, "NAM": {2024: 28000.0}, "BWA": {2024: 24000.0},
            "TZA": {2024: 6000.0},
        },
    ),
    "Cobalt": (
        "tonnes", _USGS, _USGS_MCS25, _USGS_URL,
        {
            "COD": {2024: 220000.0}, "MDG": {2024: 3000.0}, "MAR": {2024: 2300.0},
        },
    ),
    "Diamonds": (
        "carats", _USGS, _USGS_MCS25, _USGS_URL,
        {
            "BWA": {2024: 24000000.0}, "AGO": {2024: 10000000.0},
            "ZAF": {2024: 5700000.0}, "ZWE": {2024: 5000000.0},
            "NAM": {2024: 2500000.0}, "COD": {2024: 2200000.0},
            "LSO": {2024: 750000.0}, "SLE": {2024: 700000.0},
        },
    ),
    "Phosphate": (
        "tonnes", _USGS, _USGS_MCS25, _USGS_URL,
        {
            "MAR": {2024: 38000000.0}, "EGY": {2024: 5200000.0},
            "TUN": {2024: 4000000.0}, "SEN": {2024: 2900000.0},
            "ZAF": {2024: 2100000.0}, "TGO": {2024: 1600000.0},
            "DZA": {2024: 1400000.0},
        },
    ),
    "Bauxite": (
        "tonnes", _USGS, _USGS_MCS25, _USGS_URL,
        {
            "GIN": {2024: 110000000.0}, "SLE": {2024: 1900000.0},
            "GHA": {2024: 1200000.0},
        },
    ),
    "Uranium": (
        "tonnes", "USGS / World Nuclear Association", "WNA Uranium Production 2024",
        "https://world-nuclear.org/information-library/nuclear-fuel-cycle/mining-of-uranium/world-uranium-mining-production",
        {
            "NAM": {2024: 5600.0}, "NER": {2024: 2000.0}, "ZAF": {2024: 200.0},
        },
    ),
    "Iron ore": (
        "tonnes", _USGS, _USGS_MCS25, _USGS_URL,
        {
            "ZAF": {2024: 61000000.0}, "MRT": {2024: 13000000.0},
            "SLE": {2024: 3200000.0}, "LBR": {2024: 5000000.0},
        },
    ),
    "Manganese": (
        "tonnes", _USGS, _USGS_MCS25, _USGS_URL,
        {
            "ZAF": {2024: 7300000.0}, "GAB": {2024: 4700000.0},
            "GHA": {2024: 850000.0}, "CIV": {2024: 1400000.0},
        },
    ),
    "Platinum": (
        "tonnes", _USGS, _USGS_MCS25, _USGS_URL,
        {
            "ZAF": {2024: 120.0}, "ZWE": {2024: 19.0},
        },
    ),
    "Coal": (
        "tonnes", "USGS / IEA", "IEA Coal 2024",
        "https://www.iea.org/reports/coal-2024",
        {
            "ZAF": {2024: 228000000.0}, "MOZ": {2024: 9500000.0},
            "ZWE": {2024: 3200000.0}, "NGA": {2024: 600000.0},
        },
    ),
    "Crude oil": (
        "1000 b/d", "EIA / OPEC",
        ...
        {
            "NGA": {2024: 1400.0}, "LBY": {2024: 1200.0}, "AGO": {2024: 1100.0},
            "DZA": {2024: 990.0}, "EGY": {2024: 550.0}, "COG": {2024: 265.0},
            "GAB": {2024: 200.0}, "GHA": {2024: 145.0}, "SSD": {2024: 140.0},
            "TCD": {2024: 110.0}, "GNQ": {2024: 88.0}, "SDN": {2024: 60.0},
            "CMR": {2024: 58.0}, "TUN": {2024: 40.0}, "CIV": {2024: 32.0},
        },
    ),
    "Natural gas": (
        "bcm", "EIA", "EIA International Energy Statistics 2024",
        "https://www.eia.gov/international/data/world",
        {
            "DZA": {2024: 100.0}, "EGY": {2024: 58.0}, "NGA": {2024: 42.0},
            "LBY": {2024: 12.0}, "MOZ": {2024: 7.0}, "GNQ": {2024: 5.0},
            "AGO": {2024: 5.0}, "CIV": {2024: 2.5}, "TUN": {2024: 1.4},
            "GHA": {2024: 1.3},
        },
    ),
}
