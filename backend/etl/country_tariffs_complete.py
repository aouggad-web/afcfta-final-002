...
from etl.country_tariffs import (  # Afrique du Nord; CEDEAO; CEMAC; EAC; SACU/SADC
    ALGERIA_TARIFFS,
    ANGOLA_TARIFFS,
    BENIN_TARIFFS,
    BOTSWANA_TARIFFS,
    BURKINA_FASO_TARIFFS,
    BURUNDI_TARIFFS,
    CAMEROON_TARIFFS,
    CAPE_VERDE_TARIFFS,
    CEMAC_TEC,
    CENTRAL_AFRICAN_REP_TARIFFS,
    CHAD_TARIFFS,
    COMOROS_TARIFFS,
    CONGO_TARIFFS,
    DRC_TARIFFS,
    ...
    ECOWAS_TEC,
    EGYPT_TARIFFS,
    EQUATORIAL_GUINEA_TARIFFS,
    ESWATINI_TARIFFS,
    GABON_TARIFFS,
    GAMBIA_TARIFFS,
    GHANA_TARIFFS,
    GUINEA_BISSAU_TARIFFS,
    GUINEA_TARIFFS,
    IVORY_COAST_TARIFFS,
    KENYA_TARIFFS,
    LESOTHO_TARIFFS,
