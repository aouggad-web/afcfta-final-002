    ...
    def add_global_benchmarks(self):
        ...
        for port in self.ports:
            port["global_benchmarks"] = {
                ...
                "africa_avg_source": GLOBAL_BENCHMARKS[
                    "container_dwell_time_days_africa_avg_source"
                ],
                "africa_avg_note": GLOBAL_BENCHMARKS["container_dwell_time_days_afdb_note"],
                "global_median_dwell_days_h2_2023": GLOBAL_BENCHMARKS[
                    "container_dwell_time_days_global_median_h2_2023"
                ],
