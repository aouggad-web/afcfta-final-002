...
CHAPTER_CATEGORIES = {
    ...
    "07": "vegetables",
    "08": "fruits",
    "09": "coffee_tea_spices",
    "10": "cereals",
    "11": "milling",
    "12": "oilseeds",
    "13": "lac_gums",
    "14": "vegetable_materials",
    "15": "fats_oils",
    "16": "meat_preparations",
    "17": "sugar",
    "18": "cocoa",
    "19": "cereal_preparations",
    "20": "vegetable_preparations",
    "21": "misc_food",
    "22": "beverages",
    "23": "food_residues",
    "24": "tobacco",
    ...
    "26": "ores",
    "27": "mineral_fuels",
    "28": "inorganic_chemicals",
    "29": "organic_chemicals",
    "30": "pharmaceuticals",
    "31": "fertilizers",
    "32": "tanning_dyes",
    "33": "essential_oils_cosmetics",
    "34": "soap_wax",
    "35": "proteins_glues",
    "36": "explosives",
    "37": "photography",
    ...
    "90": "optical_medical",
    "91": "clocks",
    "92": "musical_instruments",
    "93": "arms",
    "94": "furniture",
    "95": "toys",
    "96": "misc_manufactured",
    "97": "art",
}
...
def generate_python_file(hs6_data, output_path):
    ...
    with open(output_path, "w", encoding="utf-8") as f:
        ...
        for code in sorted_codes:
            ...
            f.write(
                f'        "typical_sub_position_types": {entry["typical_sub_position_types"]},\n'
            )
