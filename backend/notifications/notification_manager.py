...
class NotificationManager:
    ...
    async def send_notification(
        ...
        tasks = [self._send_to_notifier(notifier, data) for notifier in self.enabled_notifiers]
    ...
    async def notify_crawl_start(
        ...
        message = (
            f"Data collection has started for {country_name or country_code} ({country_code})."
        )
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        """
        stats = {"manager": self.stats.copy(), "notifiers": {}}
