...
class TestNotificationManager:
    ...
    async def test_notify_crawl_start(self):
        ...
        results = await manager.notify_crawl_start(
            job_id="test-001", country_code="KE", country_name="Kenya"
        )
    ...
    async def test_statistics_tracking(self):
        ...
        # Send a notification
        await manager.notify_crawl_start(job_id="test-001", country_code="KE")
...
class TestIntegration:
    ...
    async def test_full_crawl_lifecycle(self):
        ...
        # Start
        await manager.notify_crawl_start(job_id=job_id, country_code=country_code)
...
def run_simple_tests():
    ...
    async def test_async():
        results = await manager.notify_crawl_start(job_id="test", country_code="TEST")
