...
def test_morocco_national_tariff_is_documented_but_vat_stays_partial():
    """Le tarif national marocain est documenté, mais la TVA reste partielle."""
...
def test_angola_hs6_is_not_misrepresented_as_a_national_extension():
    """Le référentiel AGO reste un agrégat SH6, pas une extension nationale."""
...
def test_angola_reduced_rates_are_not_fabricated():
    """Cabinda et les exonérations restent non calculables sans portée structurée."""
