...
class TestSmartSearchChapters:
    ...
    def test_chapter_70_search_with_senegal(self):
        ...
        response = requests.get(
            ...
            params={"query": "70", "country_code": "SEN", "include_sub_positions": True},
        )
    ...
    def test_chapter_71_search_with_senegal(self):
        ...
        response = requests.get(
            f"{BASE_URL}/api/hs6/smart-search",
            params={"query": "71", "country_code": "SEN", "include_sub_positions": True},
        )
    ...
    def test_chapter_info_in_response(self):
        ...
        response = requests.get(
            f"{BASE_URL}/api/hs6/smart-search", params={"query": "70", "country_code": "SEN"}
        )
    ...
    def test_text_search_verre(self):
        ...
        response = requests.get(
            f"{BASE_URL}/api/hs6/smart-search",
            params={"query": "verre", "country_code": "SEN", "language": "fr"},
        )
    ...
    def test_search_without_country_code(self):
        ...
        response = requests.get(f"{BASE_URL}/api/hs6/smart-search", params={"query": "70"})
