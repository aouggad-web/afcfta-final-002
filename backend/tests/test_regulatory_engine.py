...
class TestRegulatoryEngineDetails:
    ...
    def test_details_measures_have_npf_and_zlecaf_rates(self):
        ...
        print(
            f"✅ D.D rates: NPF={dd_measure['rate_pct']}%, ZLECAf={dd_measure['zlecaf_rate_pct']}%"
        )
    ...
    def test_details_totals_and_savings(self):
        ...
        print(
            f"✅ Totals: NPF={data['total_npf_pct']}%, ZLECAf={data['total_zlecaf_pct']}%, Savings={data['savings_pct']}%"
        )
