...
class TestHS6Search:
    ...
    def test_search_automobile(self):
        ...
        response = requests.get(
            f"{BASE_URL}/api/hs6/search", params={"query": "automobile", "limit": 10}
        )
        assert response.status_code == 200
        data = response.json()
        assert "results" in data
    ...
    def test_search_textile(self):
        ...
        response = requests.get(
            f"{BASE_URL}/api/hs6/search", params={"query": "textile", "limit": 10}
        )
        assert response.status_code == 200
        data = response.json()
        assert "results" in data
    ...
    def test_search_acier(self):
        ...
        response = requests.get(
            f"{BASE_URL}/api/hs6/search", params={"query": "acier", "limit": 10}
        )
        assert response.status_code == 200
        data = response.json()
        assert "results" in data
    ...
    def test_search_poisson(self):
        ...
        response = requests.get(
            f"{BASE_URL}/api/hs6/search", params={"query": "poisson", "limit": 10}
        )
        assert response.status_code == 200
        data = response.json()
        assert "results" in data
    ...
    def test_search_navire(self):
        ...
        response = requests.get(
            f"{BASE_URL}/api/hs6/search", params={"query": "navire", "limit": 10}
        )
        assert response.status_code == 200
        data = response.json()
        assert "results" in data
    ...
    def test_search_english(self):
        ...
        response = requests.get(
            f"{BASE_URL}/api/hs6/search", params={"query": "coffee", "language": "en", "limit": 10}
        )
        assert response.status_code == 200
        data = response.json()
        assert "results" in data
...
class TestHS6Statistics:
    ...
    def test_statistics_sensitivities(self):
        ...
        print(
            f"✅ Sensitivities: normal={sensitivities['normal']}, sensitive={sensitivities['sensitive']}, excluded={sensitivities['excluded']}"
        )
...
class TestHS6SubPositions:
    ...
    def test_suggestions_with_country(self):
        ...
        response = requests.get(
            f"{BASE_URL}/api/hs6/suggestions/870323", params={"country_code": "SEN"}
        )
        assert response.status_code == 200
        data = response.json()
        assert data["country_code"] == "SEN"
        print(
            f"✅ Suggestions for 870323 (SEN): has_country_specific_rates={data['has_country_specific_rates']}"
        )
...
class TestHS6RuleOfOrigin:
    ...
    def test_rule_of_origin_vehicle(self):
        ...
        print(
            f"✅ Rule of origin for 870323: {data['type']}, {data['regional_content']}% regional content"
        )
    ...
    def test_rule_of_origin_coffee(self):
        ...
        assert "regional_content" in data
        print(
            f"✅ Rule of origin for 090111: {data['type']}, {data['regional_content']}% regional content"
        )
...
class TestHS6ExtendedChapters:
    ...
    def test_chapter_52_cotton(self):
        ...
        response = requests.get(
            f"{BASE_URL}/api/hs6/search", params={"query": "coton", "limit": 20}
        )
        assert response.status_code == 200
        data = response.json()
...
class TestDataConsistency:
    ...
    def test_search_count_vs_statistics(self):
        ...
        search_response = requests.get(
            f"{BASE_URL}/api/hs6/search", params={"query": "00", "limit": 50}
        )
    ...
    def test_sensitivities_sum_equals_total(self):
        ...
        assert (
            sensitivity_sum == total_codes
        ), f"Sensitivity sum {sensitivity_sum} != total {total_codes}"
