...
class TestOECExportsAPI:
    ...
    def test_get_nigeria_exports(self):
        ...
        response = requests.get(
            f"{BASE_URL}/api/oec/exports/NGA", params={"year": 2022, "limit": 10}
        )
        assert response.status_code == 200
    ...
    def test_get_kenya_exports(self):
        ...
        response = requests.get(
            f"{BASE_URL}/api/oec/exports/KEN", params={"year": 2022, "limit": 5}
        )
        assert response.status_code == 200
    ...
    def test_invalid_country_exports(self):
        ...
        response = requests.get(f"{BASE_URL}/api/oec/exports/XXX", params={"year": 2022})
...
class TestOECImportsAPI:
    ...
    def test_get_kenya_imports(self):
        ...
        response = requests.get(
            f"{BASE_URL}/api/oec/imports/KEN", params={"year": 2022, "limit": 10}
        )
        assert response.status_code == 200
    ...
    def test_get_south_africa_imports(self):
        ...
        response = requests.get(
            f"{BASE_URL}/api/oec/imports/ZAF", params={"year": 2022, "limit": 5}
        )
        assert response.status_code == 200
...
class TestOECBilateralAPI:
    ...
    def test_ivory_coast_to_ghana(self):
        ...
        response = requests.get(
            f"{BASE_URL}/api/oec/bilateral/CIV/GHA", params={"year": 2022, "limit": 10}
        )
        assert response.status_code == 200
    ...
    def test_nigeria_to_south_africa(self):
        ...
        response = requests.get(
            f"{BASE_URL}/api/oec/bilateral/NGA/ZAF", params={"year": 2022, "limit": 5}
        )
        assert response.status_code == 200
    ...
    def test_invalid_exporter(self):
        ...
        response = requests.get(f"{BASE_URL}/api/oec/bilateral/XXX/GHA", params={"year": 2022})
        # Invalid country returns 400 Bad Request
        assert response.status_code == 400

    def test_invalid_importer(self):
        """Test bilateral with invalid importer - returns 400"""
        response = requests.get(f"{BASE_URL}/api/oec/bilateral/NGA/XXX", params={"year": 2022})
        # Invalid country returns 400 Bad Request
        assert response.status_code == 400
...
class TestOECAfricanExportersAPI:
    ...
    def test_top_african_coffee_exporters(self):
        ...
        response = requests.get(
            f"{BASE_URL}/api/oec/product/0901/africa", params={"year": 2022, "limit": 10}
        )
        assert response.status_code == 200
...
class TestOECDataIntegrity:
    ...
    def test_exports_response_structure(self):
        ...
        response = requests.get(
            f"{BASE_URL}/api/oec/exports/NGA", params={"year": 2022, "limit": 5}
        )
        assert response.status_code == 200
    ...
    def test_bilateral_response_structure(self):
        ...
        response = requests.get(
            f"{BASE_URL}/api/oec/bilateral/CIV/GHA", params={"year": 2022, "limit": 5}
        )
        assert response.status_code == 200
