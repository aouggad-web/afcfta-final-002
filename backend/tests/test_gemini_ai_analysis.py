...
if not BASE_URL:
    BASE_URL = "https://zlecaf-trade-ops.preview.emergentagent.com"
...
class TestAIOpportunitiesExportMode:
    ...
    def test_morocco_export_opportunities(self):
        ...
        print(
            f"SUCCESS: Morocco export analysis returned {len(data['opportunities'])} opportunities"
        )
...
class TestAIOpportunitiesImportMode:
    ...
    def test_morocco_import_opportunities(self):
        ...
        print(
            f"SUCCESS: Morocco import analysis returned {len(data['opportunities'])} opportunities"
        )
...
class TestAIOpportunitiesIndustrialMode:
    ...
    def test_nigeria_industrial_opportunities(self):
        ...
        print(
            f"SUCCESS: Nigeria industrial analysis returned {len(data['opportunities'])} opportunities"
        )
...
class TestAITradeBalance:
    ...
    def test_kenya_trade_balance(self):
        ...
        response = requests.get(
            f"{BASE_URL}/api/ai/balance/Kenya", params={"lang": "fr"}, timeout=60
        )
        assert response.status_code == 200
        data = response.json()
        ...
        assert data["country"] == "Kenya"
        print(
            f"SUCCESS: Kenya trade balance returned {len(data.get('trade_balance_history', []))} years of data"
        )
