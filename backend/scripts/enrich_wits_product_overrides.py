...
PRODUCT_OVERRIDES: Dict[str, List[ProductOverride]] = {
    "AGO": [
        ...
        ProductOverride(
            "1905",
            "IVA",
            "Imposto sobre o Valor Acrescentado (IVA) — pão",
            5.0,
            "estimation_ia",
            ...
            "2026 (permanent depuis OGE 2026)",
            'Nom légal : "pão" (pain).',
        ),
        ProductOverride(
            "0407",
        ...
        ProductOverride(
            ...
            "https://www.minfin.gov.ao/sala-de-imprensa/noticias/noticia/nova-taxa-do-iva-em-5-para-os-bens-alimentares-de-amplo-consumo-e-cesta-basica-entra-em-vigor-a-1-de-janeiro-de-2024",
            "2026",
            'Nom légal : "batata" (pomme de terre).',
        ),
        ProductOverride(
            "1101",
            "IVA",
            "IVA — farinha de trigo",
            5.0,
            "estimation_ia",
            "Anexo I Código do IVA / minfin.gov.ao",
            "https://www.minfin.gov.ao/sala-de-imprensa/noticias/noticia/nova-taxa-do-iva-em-5-para-os-bens-alimentares-de-amplo-consumo-e-cesta-basica-entra-em-vigor-a-1-de-janeiro-de-2024",
            "2026",
            'Nom légal : "farinha de trigo" (farine de blé).',
        ),
        ProductOverride(
            "1102",
            "IVA",
            "IVA — farinha de milho",
            5.0,
            "estimation_ia",
            "Anexo I Código do IVA / minfin.gov.ao",
            "https://www.minfin.gov.ao/sala-de-imprensa/noticias/noticia/nova-taxa-do-iva-em-5-para-os-bens-alimentares-de-amplo-consumo-e-cesta-basica-entra-em-vigor-a-1-de-janeiro-de-2024",
            "2026",
            'Nom légal : "farinha de milho" (farine de maïs).',
        ),
        ProductOverride(
            "2201",
            "IVA",
            "IVA — água mineral/de mesa",
            5.0,
            "estimation_ia",
            "Anexo I Código do IVA / minfin.gov.ao",
            "https://www.minfin.gov.ao/sala-de-imprensa/noticias/noticia/nova-taxa-do-iva-em-5-para-os-bens-alimentares-de-amplo-consumo-e-cesta-basica-entra-em-vigor-a-1-de-janeiro-de-2024",
            "2026",
            'Nom légal : "água mineral e de mesa".',
        ),
        ProductOverride(
            "3401",
            "IVA",
            ...
            "https://www.minfin.gov.ao/sala-de-imprensa/noticias/noticia/nova-taxa-do-iva-em-5-para-os-bens-alimentares-de-amplo-consumo-e-cesta-basica-entra-em-vigor-a-1-de-janeiro-de-2024",
            "2026",
            'Nom légal : "sabão" (savon).',
        ),
        ProductOverride(
            "0402",
            "IVA",
            "IVA — leite condensado/em pó",
            5.0,
            "estimation_ia",
            "Anexo I Código do IVA / minfin.gov.ao",
            "https://www.minfin.gov.ao/sala-de-imprensa/noticias/noticia/nova-taxa-do-iva-em-5-para-os-bens-alimentares-de-amplo-consumo-e-cesta-basica-entra-em-vigor-a-1-de-janeiro-de-2024",
            "2026",
            'Nom légal : "leite condensado e em pó".',
        ),
    ],
    "MOZ": [
        ...
        ProductOverride(
            "1001",
            "IVA",
            "IVA — trigo (exonéré, cesta básica)",
            0.0,
            "estimation_ia",
            "Art. 9(13)/12(a) Código do IVA (Lei 22/2022)",
            "https://taxsummaries.pwc.com/mozambique/corporate/other-taxes",
        ...
        ProductOverride(
            "1101",
            "IVA",
            "IVA — farinha de trigo (exonéré)",
            0.0,
            "estimation_ia",
            "Art. 9(13)/12(a) Código do IVA (Lei 22/2022)",
            "https://taxsummaries.pwc.com/mozambique/corporate/other-taxes",
            "2026",
            'Nom légal : "farinha de trigo".',
        ),
        ProductOverride(
            "1905",
            "IVA",
        ...
        ProductOverride(
            "2501",
            "IVA",
            "IVA — sal iodado (exonéré)",
            0.0,
            "estimation_ia",
            "Art. 9(13)/12(a) Código do IVA (Lei 22/2022)",
            "https://taxsummaries.pwc.com/mozambique/corporate/other-taxes",
            "2026",
            'Nom légal : "sal iodado".',
        ),
        ProductOverride(
            "0702",
            "IVA",
            ...
            "https://taxsummaries.pwc.com/mozambique/corporate/other-taxes",
            "2026",
            'Nom légal : "tomate fresco ou refrigerado".',
        ),
        ProductOverride(
            "0701",
            "IVA",
        ...
        ProductOverride(
            "401410",
            "IVA",
            "IVA — preservativos (exonéré)",
            0.0,
            "estimation_ia",
            "Art. 9(13)/12(a) Código do IVA (Lei 22/2022)",
            "https://taxsummaries.pwc.com/mozambique/corporate/other-taxes",
            "2026",
            'Nom légal : "preservativos".',
        ),
        ProductOverride(
            "380891",
            "IVA",
            "IVA — insecticidas (exonéré)",
            0.0,
            "estimation_ia",
            "Art. 9(13)/12(a) Código do IVA (Lei 22/2022)",
            "https://taxsummaries.pwc.com/mozambique/corporate/other-taxes",
            "2026",
            'Nom légal : "insecticidas".',
        ),
    ],
    "STP": [
        ProductOverride(
            "1006",
            "IVA",
            "IVA — arroz (Anexo I, panier de base)",
            7.5,
            "estimation_ia",
        ...
        ProductOverride(
            "1102",
            "IVA",
            "IVA — farinha de milho (Anexo I)",
            7.5,
            "estimation_ia",
            "Lei n.º 02/2023 de 31 de maio, Anexo I",
            "https://www.mirandalawfirm.com/pt/conhecimento-media/publications/alerts/entrada-em-vigor-do-codigo-do-iva-em-stp-2",
            "2026",
            'Nom légal : "farinha de milho" (farine de MAÏS, pas de blé).',
        ),
        ProductOverride(
            "1902",
            "IVA",
            "IVA — massas alimentícias (Anexo I)",
            7.5,
            "estimation_ia",
            "Lei n.º 02/2023 de 31 de maio, Anexo I",
            "https://www.mirandalawfirm.com/pt/conhecimento-media/publications/alerts/entrada-em-vigor-do-codigo-do-iva-em-stp-2",
            "2026",
            'Nom légal : "massas alimentícias" (pâtes).',
        ),
        ProductOverride(
            "1905",
            "IVA",
    ...
    "ZWE": [
        ...
        ProductOverride(
            "8701",
            "VAT",
            "VAT — agricultural tractors (exempt)",
            0.0,
            "loi",
        ...
        ProductOverride(
            "8432",
            "VAT",
            "VAT — tillers / soil-preparation machinery (exempt)",
            0.0,
            "loi",
            "Zimbabwe VAT Act [Chapter 23:12], Second Schedule + S.I. 15 of 2024",
            "https://www.dlapiperafrica.com",
    ...
    "MUS": [
        ...
        ProductOverride(
            "9018",
            "VAT",
            "VAT — medical/surgical/dental instruments (exempt)",
            0.0,
            "loi",
            "Mauritius VAT Act, First Schedule",
            "https://www.mra.mu/26-vat",
            "2026",
            "Liste First Schedule non exhaustive — d'autres sous-positions "
    ...
    "MWI": [
        ...
        ProductOverride(
            "0409",
            "VAT",
            "VAT — natural honey (exempt)",
            0.0,
            "estimation_ia",
            "Malawi VAT Act (Cap 42:02), First Schedule",
            "https://malawilii.org/akn/mw/act/2005/7",
            "2026",
            'Nom légal : "natural honey".',
        ),
        ProductOverride(
            "0407",
            "VAT",
            "VAT — birds' eggs (exempt)",
            0.0,
            "estimation_ia",
            "Malawi VAT Act (Cap 42:02), First Schedule",
            "https://malawilii.org/akn/mw/act/2005/7",
            "2026",
            'Nom légal : "birds\' eggs".',
        ),
        ProductOverride(
            "4901",
            "VAT",
            "VAT — printed books (exempt)",
            0.0,
            "estimation_ia",
            "Malawi VAT Act (Cap 42:02), First Schedule",
            "https://malawilii.org/akn/mw/act/2005/7",
            "2026",
            'Nom légal : "printed matter — books".',
        ),
    ],
    "SYC": [
        ProductOverride(
