...
AFRICAN_ISO3 = {
    ...
    "ESH", "STP", "SEN", "SYC", "SLE", "SOM", "ZAF", "SSD", "SDN", "TZA",
    "TGO", "TUN", "UGA", "ZMB", "ZWE",
}

COUNTRY_NAMES_FR = {
    "AGO": "l'Angola", "COM": "les Comores", "DJI": "Djibouti",
    "ERI": "l'Érythrée", "LBY": "la Libye", "MDG": "Madagascar",
    "MOZ": "le Mozambique", "MRT": "la Mauritanie", "MWI": "le Malawi",
    "SDN": "le Soudan", "SSD": "le Soudan du Sud", "STP": "Sao Tomé-et-Principe",
    "SYC": "les Seychelles", "ZMB": "la Zambie", "ZWE": "le Zimbabwe",
}

COUNTRY_NAMES_EN = {
    "AGO": "Angola", "COM": "Comoros", "DJI": "Djibouti", "ERI": "Eritrea",
    "LBY": "Libya", "MDG": "Madagascar", "MOZ": "Mozambique",
    "MRT": "Mauritania", "MWI": "Malawi", "SDN": "Sudan",
    "SSD": "South Sudan", "STP": "Sao Tomé and Principe",
    "SYC": "Seychelles", "ZMB": "Zambia", "ZWE": "Zimbabwe",
}
...
def provider_fee_flags(tax: dict) -> dict:
    ...
    return {
        ...
        "fee_label_fr": "Frais de prestataire (redevance de prestation douanière)" if is_fee else "",
    }
