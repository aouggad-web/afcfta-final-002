...
STATIC_PRODUCTION_DATA = {
    ...
    # Barley (44) - Top producers
    "44": {
        "MAR": {"2022": 2600000, "2023": 2800000, "2024": 2500000},
        "DZA": {"2022": 1950000, "2023": 2100000, "2024": 1900000},
        "EGY": {"2022": 1100000, "2023": 1150000, "2024": 1200000},
        "ETH": {"2022": 2200000, "2023": 2300000, "2024": 2400000},
        "TUN": {"2022": 400000, "2023": 450000, "2024": 420000},
        "LBY": {"2022": 90000, "2023": 95000, "2024": 92000},
    },
    # Potatoes (116) - Top producers
    "116": {
        "DZA": {"2022": 5000000, "2023": 5200000, "2024": 5400000},
        "EGY": {"2022": 4800000, "2023": 5000000, "2024": 5200000},
        "MAR": {"2022": 2000000, "2023": 2100000, "2024": 2200000},
        "ZAF": {"2022": 2300000, "2023": 2400000, "2024": 2350000},
        "ETH": {"2022": 1200000, "2023": 1300000, "2024": 1400000},
        "TUN": {"2022": 450000, "2023": 470000, "2024": 480000},
        "KEN": {"2022": 2000000, "2023": 2100000, "2024": 2200000},
    },
...
def get_production_data(
    ...
    for comm_code in commodities:
        ...
        commodity_info = KEY_COMMODITIES.get(
            comm_code, {"name_en": comm_code, "name_fr": comm_code}
        )
                ...
                results.append(
                    {
                        ...
                        "commodity_name": commodity_info.get(
                            f"name_{language}", commodity_info["name_en"]
                        ),
...
def get_top_producers(
    commodity_code: str, year: int = 2024, limit: int = 10, language: str = "fr"
) -> List[Dict]:
...
def get_production_trends(country_iso3: str, commodity_code: str, language: str = "fr") -> Dict:
    ...
    data = get_production_data(
        country_iso3=country_iso3, commodity_code=commodity_code, language=language
    )
