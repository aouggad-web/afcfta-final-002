...
from etl.translations import translate_country_list, translate_product
...
def translate_products_list(products: list, language: str = "fr") -> list:
    ...
    for product in products:
        ...
        if "top_importers" in product:
            translated_product["top_importers"] = translate_country_list(
                product["top_importers"], language
            )
        if "top_exporters" in product:
            translated_product["top_exporters"] = translate_country_list(
                product["top_exporters"], language
            )
...
async def get_gdp_history_top10():
    ...
    return {
        ...
        "years": years,
        "countries": [
            {"iso3": s["iso3"], "country": s["country"], "gdp_2024_billion": s["gdp_2024_billion"]}
            for s in series
        ],
        "series": series,
...
TRADE_PERFORMANCE_INTRA_AFRICAN_2024 = [
    ...
    },
    {
        ...
        "exports_2024": 5.8,
        "imports_2024": 3.1,
        "trade_balance_2024": 2.7,
        "intra_african_percentage": 31.4,
    },
    {
        "code": "MA",
        "country": "Maroc",
    ...
    },
    {
        ...
        "exports_2024": 4.8,
        "imports_2024": 2.4,
        "trade_balance_2024": 2.4,
        "intra_african_percentage": 37.5,
    },
    {
        "code": "TN",
        "country": "Tunisie",
    ...
    },
    {
        ...
        "exports_2024": 3.6,
        "imports_2024": 2.1,
        "trade_balance_2024": 1.5,
        "intra_african_percentage": 42.4,
    },
    {
        "code": "DZ",
        "country": "Algérie",
    ...
    },
    {
        ...
        "exports_2024": 3.1,
        "imports_2024": 1.5,
        "trade_balance_2024": 1.6,
        "intra_african_percentage": 73.8,
    },
    {
        "code": "AO",
        "country": "Angola",
        "exports_2024": 2.1,
        "imports_2024": 1.2,
        "trade_balance_2024": 0.9,
        "intra_african_percentage": 4.9,
    },
]
