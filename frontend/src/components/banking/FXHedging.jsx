            ...
            <div className="mt-6 space-y-4">
              ...
              <Card className="bg-[color-mix(in_srgb,var(--info)_8%,var(--afcfta-card))]">
                <CardContent className="pt-4">
                  ...
                  <p className="text-sm text-[var(--text)] mt-2">{result.explanation}</p>
                </CardContent>
              </Card>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-2">
                    {result.all_strategies.map((strat, i) => (
                      <div key={i} className="p-2 bg-[var(--afcfta-card2)] rounded text-sm">
                        <div className="font-medium">{strat.name}</div>
                        <div className="grid grid-cols-3 gap-2 mt-1 text-xs text-[var(--afcfta-muted)]">
