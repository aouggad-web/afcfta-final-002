...
// All ports that appear in the fee dataset — sorted alphabetically by name
const FEE_PORTS = [
  ...
  { locode: 'DZAAE', name: 'Annaba',         country: 'Algérie',         flag: '🇩🇿' },
  { locode: 'MZBEW', name: 'Beira',          country: 'Mozambique',      flag: '🇲🇿' },
  { locode: 'DZBEJ', name: 'Béjaïa',         country: 'Algérie',         flag: '🇩🇿' },
  { locode: 'ZACPT', name: 'Cape Town',      country: 'Afrique du Sud',  flag: '🇿🇦' },
  { locode: 'MACAS', name: 'Casablanca',     country: 'Maroc',           flag: '🇲🇦' },
  { locode: 'GNCKY', name: 'Conakry',        country: 'Guinée',          flag: '🇬🇳' },
  { locode: 'BJCOO', name: 'Cotonou',        country: 'Bénin',           flag: '🇧🇯' },
  ...
  { locode: 'DZGHZ', name: 'Ghazaouet',      country: 'Algérie',         flag: '🇩🇿' },
  { locode: 'DZAJJ', name: 'Jijel',          country: 'Algérie',         flag: '🇩🇿' },
  { locode: 'NGAPP', name: 'Lagos (Apapa)',   country: 'Nigeria',         flag: '🇳🇬' },
  { locode: 'GALIB', name: 'Libreville',     country: 'Gabon',           flag: '🇬🇦' },
  { locode: 'TGLFW', name: 'Lomé',           country: 'Togo',            flag: '🇹🇬' },
  ...
  { locode: 'DZMGD', name: 'Mostaganem',     country: 'Algérie',         flag: '🇩🇿' },
  { locode: 'MRNDB', name: 'Nouadhibou',     country: 'Mauritanie',      flag: '🇲🇷' },
  { locode: 'DZORN', name: 'Oran',           country: 'Algérie',         flag: '🇩🇿' },
  ...
  { locode: 'SDPZU', name: 'Port Soudan',    country: 'Soudan',          flag: '🇸🇩' },
  { locode: 'TNRAD', name: 'Radès',          country: 'Tunisie',         flag: '🇹🇳' },
  { locode: 'TNSFA', name: 'Sfax',           country: 'Tunisie',         flag: '🇹🇳' },
  { locode: 'DZSKL', name: 'Skikda',         country: 'Algérie',         flag: '🇩🇿' },
  { locode: 'MAPTM', name: 'Tanger Med',     country: 'Maroc',           flag: '🇲🇦' },
  { locode: 'GHTEM', name: 'Tema',           country: 'Ghana',           flag: '🇬🇭' },
  { locode: 'LYTIP', name: 'Tripoli',        country: 'Libye',           flag: '🇱🇾' },
