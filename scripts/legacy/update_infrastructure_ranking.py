...
def update_infrastructure():
    ...
    for name in all_country_names:
        ...
        if name in LPI_2023_SCORES:
            ...
            if score >= 3.4:
                entry["rang_mondial_ipl"] = 24
            elif score >= 3.1:
                entry["rang_mondial_ipl"] = 40
            elif score >= 2.9:
                entry["rang_mondial_ipl"] = 60
            elif score >= 2.6:
                entry["rang_mondial_ipl"] = 80
            elif score >= 2.4:
                entry["rang_mondial_ipl"] = 100
            else:
                entry["rang_mondial_ipl"] = 120
