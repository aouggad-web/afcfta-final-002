...
COUNTRY_PROFILES = {
    ...
    "ZAF": {
        ...
        "industry": 25.6,
        "manuf": 12.1,
        "main_crops": ["Maize (corn)", "Sugarcane", "Wheat"],
        "minerals": ["Gold", "Platinum", "Coal"],
    },
    "NGA": {
        "agri": 23.8,
        "industry": 27.4,
        "manuf": 8.9,
        "main_crops": ["Cassava", "Yam", "Maize (corn)"],
        "minerals": ["Crude oil", "Natural gas", "Tin"],
    },
    "EGY": {
        "agri": 11.3,
        "industry": 34.2,
        "manuf": 16.8,
        "main_crops": ["Wheat", "Rice", "Maize (corn)"],
        "minerals": ["Crude oil", "Natural gas", "Phosphate"],
    },
    ...
    "KEN": {
        ...
        "industry": 17.8,
        "manuf": 7.6,
        "main_crops": ["Tea", "Maize (corn)", "Coffee"],
        "minerals": ["Soda ash", "Fluorspar", "Titanium"],
    },
    "ETH": {
        "agri": 33.1,
        "industry": 21.6,
        "manuf": 5.2,
        "main_crops": ["Maize (corn)", "Teff", "Coffee"],
        "minerals": ["Gold", "Tantalum", "Potash"],
    },
    "GHA": {
        "agri": 18.3,
        "industry": 33.8,
        "manuf": 11.2,
        "main_crops": ["Cocoa beans", "Cassava", "Maize (corn)"],
    ...
    "TZA": {
        ...
        "industry": 26.6,
        "manuf": 8.4,
        "main_crops": ["Maize (corn)", "Cassava", "Rice"],
        "minerals": ["Gold", "Diamonds", "Tanzanite"],
    },
    "CIV": {
        "agri": 16.8,
        "industry": 28.4,
        "manuf": 12.7,
        "main_crops": ["Cocoa beans", "Cashew nuts", "Rubber"],
        "minerals": ["Gold", "Diamonds", "Nickel"],
    },
    "MAR": {
        "agri": 11.9,
        "industry": 25.7,
        "manuf": 15.3,
        "main_crops": ["Wheat", "Barley", "Citrus fruits"],
        "minerals": ["Phosphate", "Zinc", "Lead"],
    },
    "SEN": {
        "agri": 14.2,
        "industry": 24.1,
        "manuf": 13.8,
        "main_crops": ["Groundnuts", "Millet", "Maize (corn)"],
        "minerals": ["Gold", "Phosphate", "Zircon"],
    },
    ...
    "DZA": {
        ...
        "minerals": ["Crude oil", "Natural gas", "Iron ore"],
    },
    "AGO": {
        "agri": 8.2,
        "industry": 51.3,
        "manuf": 4.8,
        "main_crops": ["Cassava", "Maize (corn)", "Sweet potatoes"],
        "minerals": ["Crude oil", "Diamonds", "Iron ore"],
    },
    "LBY": {
        "agri": 2.1,
        "industry": 52.4,
        ...
        "minerals": ["Crude oil", "Natural gas", "Gypsum"],
    },
    "GAB": {
        "agri": 3.7,
        "industry": 48.9,
        "manuf": 6.1,
        "main_crops": ["Cassava", "Plantain", "Sugarcane"],
        "minerals": ["Crude oil", "Manganese", "Gold"],
    },
    "GNQ": {
        "agri": 2.3,
        "industry": 68.7,
        "manuf": 1.8,
        "main_crops": ["Cassava", "Sweet potatoes", "Cocoa beans"],
        "minerals": ["Crude oil", "Natural gas", "Gold"],
    },
    "COG": {
        "agri": 7.8,
        "industry": 56.2,
        "manuf": 7.3,
        "main_crops": ["Cassava", "Sugarcane", "Plantain"],
        "minerals": ["Crude oil", "Copper", "Gold"],
    },
    # Économies minières
    "COD": {
        "agri": 19.7,
        "industry": 43.6,
        "manuf": 8.9,
        "main_crops": ["Cassava", "Maize (corn)", "Plantain"],
        "minerals": ["Copper", "Cobalt", "Diamonds"],
    },
    "ZMB": {
        "agri": 7.5,
        "industry": 41.2,
        "manuf": 7.8,
        "main_crops": ["Maize (corn)", "Cassava", "Sweet potatoes"],
        "minerals": ["Copper", "Cobalt", "Gold"],
    },
    "BWA": {
        "agri": 1.8,
        "industry": 27.5,
        "manuf": 4.2,
        "main_crops": ["Sorghum", "Maize (corn)", "Millet"],
        "minerals": ["Diamonds", "Copper", "Nickel"],
    },
    "NAM": {
        "agri": 6.2,
        "industry": 31.4,
        "manuf": 9.7,
        "main_crops": ["Millet", "Maize (corn)", "Wheat"],
        "minerals": ["Diamonds", "Uranium", "Gold"],
    },
    "ZWE": {
        "agri": 11.9,
        "industry": 28.7,
        "manuf": 10.1,
        "main_crops": ["Maize (corn)", "Tobacco", "Wheat"],
        "minerals": ["Platinum", "Gold", "Diamonds"],
    },
    # Économies agricoles
    "MLI": {
        "agri": 38.5,
        "industry": 19.1,
        "manuf": 6.2,
        "main_crops": ["Millet", "Sorghum", "Rice"],
        "minerals": ["Gold", "Phosphate", "Salt"],
    },
    "BFA": {
        "agri": 26.3,
        "industry": 26.4,
        "manuf": 8.1,
        "main_crops": ["Millet", "Sorghum", "Maize (corn)"],
        "minerals": ["Gold", "Zinc", "Manganese"],
    },
    "UGA": {
        "agri": 24.1,
        "industry": 21.3,
        "manuf": 8.7,
        "main_crops": ["Coffee", "Tea", "Maize (corn)"],
        "minerals": ["Gold", "Copper", "Cobalt"],
    },
    "RWA": {
        "agri": 28.3,
        "industry": 18.2,
        "manuf": 6.4,
        "main_crops": ["Tea", "Coffee", "Cassava"],
    ...
    "BDI": {
        ...
        "manuf": 5.3,
        "main_crops": ["Coffee", "Tea", "Maize (corn)"],
        "minerals": ["Gold", "Nickel", "Cobalt"],
    },
    "MWI": {
        "agri": 28.6,
        "industry": 15.4,
        "manuf": 6.8,
        "main_crops": ["Maize (corn)", "Tobacco", "Tea"],
        "minerals": ["Uranium", "Coal", "Bauxite"],
    },
    "TCD": {
        "agri": 42.7,
        "industry": 14.7,
        "manuf": 3.1,
        "main_crops": ["Millet", "Sorghum", "Groundnuts"],
        "minerals": ["Crude oil", "Gold", "Uranium"],
    },
    "NER": {
        "agri": 39.9,
        "industry": 19.5,
        "manuf": 5.7,
        "main_crops": ["Millet", "Sorghum", "Cowpeas"],
        "minerals": ["Uranium", "Gold", "Coal"],
    },
    "CAF": {
        "agri": 43.2,
        "industry": 14.9,
        "manuf": 5.1,
        "main_crops": ["Cassava", "Groundnuts", "Maize (corn)"],
        "minerals": ["Diamonds", "Gold", "Uranium"],
    },
    ...
    "TUN": {
        ...
        "industry": 26.2,
        "manuf": 14.9,
        "main_crops": ["Wheat", "Barley", "Olives"],
        "minerals": ["Phosphate", "Crude oil", "Natural gas"],
    },
    "CMR": {
        "agri": 16.7,
        "industry": 26.5,
        "manuf": 14.1,
        "main_crops": ["Cassava", "Maize (corn)", "Plantain"],
        "minerals": ["Crude oil", "Bauxite", "Iron ore"],
    },
    "MOZ": {
        "agri": 23.9,
        "industry": 21.5,
        "manuf": 9.3,
        "main_crops": ["Cassava", "Maize (corn)", "Rice"],
        "minerals": ["Coal", "Natural gas", "Titanium"],
    },
    "SDN": {
        "agri": 30.5,
        "industry": 24.1,
        "manuf": 7.2,
        "main_crops": ["Sorghum", "Millet", "Wheat"],
        "minerals": ["Gold", "Crude oil", "Chromite"],
    },
    "MDG": {
        "agri": 24.2,
        "industry": 19.7,
        "manuf": 11.6,
        "main_crops": ["Rice", "Cassava", "Sugarcane"],
        "minerals": ["Nickel", "Cobalt", "Ilmenite"],
    },
    # Petites économies
    "BEN": {
        "agri": 26.1,
        ...
        "manuf": 8.9,
        "main_crops": ["Cassava", "Yam", "Maize (corn)"],
        "minerals": ["Gold", "Limestone", "Marble"],
    },
    "TGO": {
        "agri": 19.8,
        "industry": 21.9,
        "manuf": 7.4,
        "main_crops": ["Cassava", "Yam", "Maize (corn)"],
        "minerals": ["Phosphate", "Limestone", "Marble"],
    },
    "SLE": {
        "agri": 60.7,
        "industry": 6.5,
        "manuf": 2.1,
        "main_crops": ["Rice", "Cassava", "Oil palm"],
        "minerals": ["Diamonds", "Rutile", "Bauxite"],
    },
    "LBR": {
        "agri": 34.0,
        "industry": 13.8,
        "manuf": 3.7,
        "main_crops": ["Cassava", "Rice", "Rubber"],
    ...
    "GIN": {
        ...
        "industry": 32.1,
        "manuf": 5.3,
        "main_crops": ["Rice", "Cassava", "Maize (corn)"],
        "minerals": ["Bauxite", "Gold", "Diamonds"],
    },
    "GNB": {
        "agri": 45.8,
        "industry": 13.1,
        "manuf": 8.2,
        "main_crops": ["Rice", "Cashew nuts", "Groundnuts"],
        "minerals": ["Bauxite", "Phosphate", "Gold"],
    },
    "MRT": {
        "agri": 25.3,
        "industry": 29.3,
        "manuf": 8.7,
        "main_crops": ["Millet", "Sorghum", "Dates"],
        "minerals": ["Iron ore", "Gold", "Copper"],
    },
    "GMB": {
        "agri": 20.4,
        "industry": 14.2,
        "manuf": 5.8,
        "main_crops": ["Groundnuts", "Millet", "Sorghum"],
        "minerals": ["Zircon", "Ilmenite", "Rutile"],
    },
    "LSO": {
        "agri": 5.8,
        "industry": 32.4,
        "manuf": 11.2,
        "main_crops": ["Maize (corn)", "Wheat", "Sorghum"],
        "minerals": ["Diamonds", "Water (export)", "Wool"],
    },
    "SWZ": {
        "agri": 6.5,
        "industry": 44.9,
        "manuf": 37.1,
        "main_crops": ["Sugarcane", "Maize (corn)", "Citrus fruits"],
        "minerals": ["Coal", "Diamonds", "Gold"],
    },
    "DJI": {
        "agri": 2.4,
        "industry": 16.6,
        "manuf": 3.1,
        "main_crops": ["Vegetables", "Fruits", "Livestock"],
        "minerals": ["Salt", "Perlite", "Limestone"],
    },
    "ERI": {
        "agri": 11.7,
        "industry": 22.6,
        "manuf": 5.4,
        "main_crops": ["Sorghum", "Millet", "Barley"],
    ...
    "SOM": {
        ...
        "industry": 7.4,
        "manuf": 2.9,
        "main_crops": ["Sorghum", "Maize (corn)", "Sesame"],
        "minerals": ["Uranium", "Iron ore", "Tin"],
    },
    "SSD": {
        "agri": 15.2,
        "industry": 54.3,
        "manuf": 4.1,
        "main_crops": ["Sorghum", "Maize (corn)", "Cassava"],
        "minerals": ["Crude oil", "Gold", "Diamonds"],
    },
    ...
    "MUS": {
        ...
        "industry": 20.1,
        "manuf": 13.7,
        "main_crops": ["Sugarcane", "Tea", "Vegetables"],
        "minerals": ["Salt", "Basalt", "Limestone"],
    },
    "SYC": {
        "agri": 2.1,
        "industry": 13.4,
        "manuf": 6.2,
        "main_crops": ["Coconuts", "Cinnamon", "Vanilla"],
        "minerals": ["Granite", "Guano", "Salt"],
    },
    "CPV": {
        "agri": 8.9,
        "industry": 19.3,
        "manuf": 5.1,
        "main_crops": ["Maize (corn)", "Beans", "Sweet potatoes"],
        "minerals": ["Salt", "Pozzolana", "Limestone"],
    },
    "STP": {
        "agri": 11.8,
        "industry": 14.7,
        "manuf": 4.3,
        "main_crops": ["Cocoa beans", "Coconuts", "Coffee"],
        "minerals": ["None significant", "Basalt", "Limestone"],
    },
    "COM": {
        "agri": 32.4,
        "industry": 11.8,
        "manuf": 4.2,
        "main_crops": ["Vanilla", "Cloves", "Ylang-ylang"],
        "minerals": ["None significant", "Pumice", "Basalt"],
    },
}
...
print(
    f"   📁 Total: {len(all_value_added) + len(all_agriculture) + len(all_manufacturing) + len(all_mining)} enregistrements"
)
