...
def create_enhanced_excel_2024():
    ...
    for _, row in df_2024.iterrows():
        ...
        enhanced_entry = {
            ...
            "Export_Produit_1": (
                econ_data.get("exports_top", ["N/A"])[0] if econ_data.get("exports_top") else "N/A"
            ),
            "Export_Produit_2": (
                econ_data.get("exports_top", ["N/A", "N/A"])[1]
                if len(econ_data.get("exports_top", [])) > 1
                else "N/A"
            ),
            "Export_Produit_3": (
                econ_data.get("exports_top", ["N/A", "N/A", "N/A"])[2]
                if len(econ_data.get("exports_top", [])) > 2
                else "N/A"
            ),
            "Export_Produit_4": (
                econ_data.get("exports_top", ["N/A", "N/A", "N/A", "N/A"])[3]
                if len(econ_data.get("exports_top", [])) > 3
                else "N/A"
            ),
            "Export_Produit_5": (
                econ_data.get("exports_top", ["N/A", "N/A", "N/A", "N/A", "N/A"])[4]
                if len(econ_data.get("exports_top", [])) > 4
                else "N/A"
            ),
            # Principaux produits importés (Top 5)
            "Import_Produit_1": (
                econ_data.get("imports_top", ["N/A"])[0] if econ_data.get("imports_top") else "N/A"
            ),
            "Import_Produit_2": (
                econ_data.get("imports_top", ["N/A", "N/A"])[1]
                if len(econ_data.get("imports_top", [])) > 1
                else "N/A"
            ),
            "Import_Produit_3": (
                econ_data.get("imports_top", ["N/A", "N/A", "N/A"])[2]
                if len(econ_data.get("imports_top", [])) > 2
                else "N/A"
            ),
            "Import_Produit_4": (
                econ_data.get("imports_top", ["N/A", "N/A", "N/A", "N/A"])[3]
                if len(econ_data.get("imports_top", [])) > 3
                else "N/A"
            ),
            "Import_Produit_5": (
                econ_data.get("imports_top", ["N/A", "N/A", "N/A", "N/A", "N/A"])[4]
                if len(econ_data.get("imports_top", [])) > 4
                else "N/A"
            ),
            # Principaux partenaires commerciaux
            "Partenaire_Export_1": (
                econ_data.get("partenaires_export", ["N/A"])[0]
                if econ_data.get("partenaires_export")
                else "N/A"
            ),
            "Partenaire_Export_2": (
                econ_data.get("partenaires_export", ["N/A", "N/A"])[1]
                if len(econ_data.get("partenaires_export", [])) > 1
                else "N/A"
            ),
            "Partenaire_Import_1": (
                econ_data.get("partenaires_import", ["N/A"])[0]
                if econ_data.get("partenaires_import")
                else "N/A"
            ),
            "Partenaire_Import_2": (
                econ_data.get("partenaires_import", ["N/A", "N/A"])[1]
                if len(econ_data.get("partenaires_import", [])) > 1
                else "N/A"
            ),
        ...
        print(
            f"   ✅ {pays}: PIB {econ_data.get('pib_2024', 0):.1f}Mds, Exports {econ_data.get('exports_2024', 0):.1f}Mds, S&P: {ratings.get('sp', 'NR')}"
        )
    ...
    # Top 5 exportateurs
    top_exporters = df_enhanced.nlargest(5, "Exportations_2024_Mds_USD")[
        ["Pays", "Exportations_2024_Mds_USD"]
    ]
