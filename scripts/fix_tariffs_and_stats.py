...
REAL_ZLECAF_TARIFFS = {
    ...
    "33": {
        ...
        "zlecaf": 0.00,
        "transition": "5_years",
    },  # Huiles essentielles et cosmétiques
    ...
    "86": {
        ...
        "zlecaf": 0.00,
        "transition": "immediate",
    },  # Véhicules et matériel ferroviaires
    "87": {
        "normal": 0.25,
        "zlecaf": 0.15,
        "transition": "10_years",
    },  # Véhicules automobiles (exception)
    ...
    "trade_partners_intra_africa_2024": [
        {
            ...
            "to": "Regional",
            "value": 24.8,
            "description": "Afrique du Sud vers région australe",
        },
        {
            "from": "NGA",
            "to": "Regional",
            "value": 18.3,
            "description": "Nigeria vers Afrique de l'Ouest",
        },
        {
            "from": "EGY",
            "to": "Regional",
            "value": 16.7,
            "description": "Égypte vers Afrique du Nord/Est",
        },
        {
            "from": "MAR",
            "to": "Regional",
            "value": 14.2,
            "description": "Maroc vers Afrique de l'Ouest/Nord",
        },
        {
            "from": "KEN",
            "to": "Regional",
            "value": 11.9,
            "description": "Kenya vers Afrique de l'Est",
        },
    ],
...
def create_corrected_tariff_structure():
    ...
    for hs2, data in REAL_ZLECAF_TARIFFS.items():
        ...
        print(
            f"   HS{hs2}: Normal {data['normal']*100:.0f}% → ZLECAf {data['zlecaf']*100:.0f}% ({data['transition']})"
        )
...
def create_enhanced_statistics():
    ...
    base_stats = {
        ...
        "trade_evolution": {
            "intra_african_trade_2023": TRADE_DATA_2023_2024["overview"][
                "total_intra_african_trade_2023"
            ],
            "intra_african_trade_2024": TRADE_DATA_2023_2024["overview"][
                "total_intra_african_trade_2024"
            ],
    ...
    print(
        f"   ✅ Commerce intra-africain 2024: {base_stats['trade_evolution']['intra_african_trade_2024']:.1f} Mds USD"
    )
    print(
        f"   ✅ Croissance 2023-2024: +{base_stats['trade_evolution']['growth_rate_2023_2024']:.1f}%"
    )
