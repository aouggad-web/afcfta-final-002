...
class ZLECAfAPITester:
    def __init__(self):
        ...
        self.session.headers.update(
            {"Content-Type": "application/json", "User-Agent": "ZLECAf-API-Tester/1.0"}
        )
        self.results = []
    ...
    def test_api_root(self):
        ...
        try:
            ...
            self.log_result(
                "API Root Endpoint", False, f"Erreur de connexion: {str(e)}", {"error": str(e)}
            )
    ...
    def test_countries_list(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                missing_countries = [
                    code for code in expected_countries if code not in country_codes
                ]
        ...
        for country_code, expected_data in test_countries_data.items():
            try:
                response = self.session.get(
                    f"{self.base_url}/country-profile/{country_code}", timeout=TIMEOUT
                )
                ...
                if response.status_code == 200:
                    ...
                    if not gdp_check:
                        self.log_result(
                            ...
                            {
                                "actual_gdp": profile.get("gdp_usd"),
                                "expected_gdp": expected_data["expected_gdp"],
                            },
                        )
                        continue
                    ...
                    if not pop_check:
                        self.log_result(
                            ...
                            {
                                "actual_pop": profile.get("population"),
                                "expected_pop": expected_data["expected_pop"],
                            },
                        )
                        continue
    ...
    def test_rules_of_origin(self):
        ...
        for hs_code in test_codes:
            try:
                response = self.session.get(
                    f"{self.base_url}/rules-of-origin/{hs_code}", timeout=TIMEOUT
                )
                ...
                if response.status_code == 200:
                    ...
                    missing_rule_fields = [
                        field for field in required_rule_fields if field not in rules_data
                    ]
    ...
    def test_tax_implementation_senegal_cote_ivoire(self):
        ...
        try:
            response = self.session.post(
                f"{self.base_url}/calculate-tariff", json=test_payload, timeout=TIMEOUT
            )
            ...
            if response.status_code == 200:
                ...
                required_tax_fields = [
                    "normal_vat_amount",
                    "normal_vat_rate",
                    "normal_statistical_fee",
                    "normal_community_levy",
                    "normal_ecowas_levy",
                    "normal_total_cost",
                    "zlecaf_total_cost",
                ...
                missing_fields = [
                    field for field in required_tax_fields if field not in calculation
                ]
                ...
                expected_vat_base = (
                    value + customs_duty + statistical_fee + community_levy + ecowas_levy
                )
                ...
                if not all(tax_checks):
                    self.log_result(
                        ...
                        {
                            "statistical_fee": {
                                "actual": statistical_fee,
                                "expected": expected_statistical_fee,
                            },
                            "community_levy": {
                                "actual": community_levy,
                                "expected": expected_community_levy,
                            },
                            "ecowas_levy": {
                                "actual": ecowas_levy,
                                "expected": expected_ecowas_levy,
                            },
                        },
                    )
                    return
                ...
                expected_total_savings = (
                    calculation["normal_total_cost"] - calculation["zlecaf_total_cost"]
                )
                expected_savings_percentage = (
                    expected_total_savings / calculation["normal_total_cost"]
                ) * 100
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                required_fields = [
                    ...
                    "value",
                    "normal_tariff_rate",
                    "normal_tariff_amount",
                    "zlecaf_tariff_rate",
                    "zlecaf_tariff_amount",
                    "savings",
                    "savings_percentage",
                    "rules_of_origin",
                ]
    ...
    def test_statistics(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                missing_sections = [
                    section for section in required_sections if section not in stats
                ]
                ...
                required_overview_fields = [
                    "total_calculations",
                    "african_countries_members",
                    "combined_population",
                    "estimated_combined_gdp",
                ]
                missing_overview_fields = [
                    field for field in required_overview_fields if field not in overview
                ]
                ...
                required_impact_fields = [
                    "average_tariff_reduction",
                    "estimated_trade_creation",
                    "job_creation_potential",
                ]
                missing_impact_fields = [
                    field for field in required_impact_fields if field not in zlecaf_impact
                ]
    ...
    def test_production_macro_country(self):
        ...
        try:
            response = self.session.get(
                f"{self.base_url}/production/macro/{test_country}", timeout=TIMEOUT
            )
    ...
    def test_production_agriculture_country(self):
        ...
        try:
            response = self.session.get(
                f"{self.base_url}/production/agriculture/{test_country}", timeout=TIMEOUT
            )
    ...
    def test_production_manufacturing(self):
        ...
        try:
            response = self.session.get(
                f"{self.base_url}/production/manufacturing", timeout=TIMEOUT
            )
    ...
    def test_production_manufacturing_country(self):
        ...
        try:
            response = self.session.get(
                f"{self.base_url}/production/manufacturing/{test_country}", timeout=TIMEOUT
            )
    ...
    def test_production_mining_country(self):
        ...
        try:
            response = self.session.get(
                f"{self.base_url}/production/mining/{test_country}", timeout=TIMEOUT
            )
    ...
    def test_production_overview_country(self):
        ...
        try:
            response = self.session.get(
                f"{self.base_url}/production/overview/{test_country}", timeout=TIMEOUT
            )
            ...
            if response.status_code == 200:
                ...
                for dimension in dimensions:
                    if isinstance(data[dimension], list):
                        ...
                        total_records += sum(
                            len(v) if isinstance(v, list) else 1 for v in data[dimension].values()
                        )
                ...
                self.log_result(
                    ...
                    f"Vue complète {test_country} validée - 4 dimensions avec {total_records} enregistrements totaux",
                    {
                        ...
                        "value_added_count": (
                            len(data["value_added"])
                            if isinstance(data["value_added"], list)
                            else "dict"
                        ),
                        "agriculture_count": (
                            len(data["agriculture"])
                            if isinstance(data["agriculture"], list)
                            else "dict"
                        ),
                        "manufacturing_count": (
                            len(data["manufacturing"])
                            if isinstance(data["manufacturing"], list)
                            else "dict"
                        ),
                        "mining_count": (
                            len(data["mining"]) if isinstance(data["mining"], list) else "dict"
                        ),
                    },
                )
    ...
    def test_production_filtering(self):
        ...
        try:
            response = self.session.get(
                f"{self.base_url}/production/macro?country_iso3=ZAF", timeout=TIMEOUT
            )
        ...
        try:
            response = self.session.get(
                f"{self.base_url}/production/macro?year=2024", timeout=TIMEOUT
            )
        ...
        try:
            response = self.session.get(
                f"{self.base_url}/production/agriculture?commodity=Maize", timeout=TIMEOUT
            )
            ...
            if response.status_code == 200:
                ...
                if not all("Maize" in record.get("commodity_label", "") for record in data):
                    self.log_result(
                        ...
                        {
                            "sample_commodities": [
                                record.get("commodity_label", "") for record in data[:5]
                            ]
                        },
                    )
                    return
            ...
            if response.status_code == 200:
                ...
                if len(ongoing_projects) > 0:
                    ...
                    missing_project_fields = [
                        field for field in expected_project_fields if field not in sample_project
                    ]
                ...
                if infrastructure_ranking:
                    ...
                    available_ranking_fields = [
                        ...
                        if field in infrastructure_ranking
                    ]
                ...
                if projects_valid and ranking_valid:
                    ...
                    self.log_result(
                        ...
                        {"projects": projects_details, "infrastructure_ranking": ranking_details},
                    )
    ...
    def test_tanger_med_port_performance_metrics_authority(self):
        ...
        try:
            ...
            response = self.session.get(
                f"{self.base_url}/logistics/ports?country_iso=MAR", timeout=TIMEOUT
            )
            ...
            for port in ports:
                if (
                    "tanger" in port.get("port_name", "").lower()
                    and "med" in port.get("port_name", "").lower()
                ):
            ...
            response = self.session.get(
                f"{self.base_url}/logistics/ports/{port_id}", timeout=TIMEOUT
            )
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                missing_authority_fields = [
                    field for field in required_authority_fields if field not in port_authority
                ]
    ...
    def test_specific_port_data_alger(self):
        ...
        try:
            ...
            response = self.session.get(
                f"{self.base_url}/logistics/ports?country_iso=DZA", timeout=TIMEOUT
            )
            ...
            if response.status_code == 200:
                ...
                if authority["contact_phone"] != expected_phone:
                    self.log_result(
                        ...
                        {
                            "actual_phone": authority["contact_phone"],
                ...
                if expected_authority_name not in authority["name"]:
                    self.log_result(
                        ...
                        {
                            "actual_name": authority["name"],
                            "expected_contains": expected_authority_name,
                        },
                    )
                    return
            ...
            if response.status_code == 200:
                ...
                if authority["website"] != expected_website:
                    self.log_result(
                        ...
                        {
                            "actual_website": authority["website"],
    ...
    def test_specific_port_data_dakar(self):
        ...
        try:
            ...
            response = self.session.get(
                f"{self.base_url}/logistics/ports?country_iso=SEN", timeout=TIMEOUT
            )
            ...
            if response.status_code == 200:
                ...
                if expected_authority_contains not in authority["name"]:
                    self.log_result(
                        ...
                        {
                            "actual_name": authority["name"],
                            "expected_contains": expected_authority_contains,
                        },
                    )
                    return
                    ...
                    if "agents" in port:
                        ...
                        for agent in port_agents:
                            ...
                            if (
                                "website" in agent
                                and agent["website"]
                                and agent["website"] != "Non disponible"
                            ):
    ...
    def test_port_details_endpoint(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                missing_authority_fields = [
                    field for field in authority_fields if field not in authority
                ]
    ...
    def test_faostat_statistics(self):
        ...
        try:
            response = self.session.get(
                f"{self.base_url}/production/faostat/statistics", timeout=TIMEOUT
            )
    ...
    def test_faostat_country_civ(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if missing_fields:
                    self.log_result(
                        "FAOSTAT CIV", False, f"Champs manquants: {missing_fields}", {"data": data}
                    )
                    return
    ...
    def test_faostat_country_egy(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if missing_fields:
                    self.log_result(
                        "FAOSTAT EGY", False, f"Champs manquants: {missing_fields}", {"data": data}
                    )
                    return
    ...
    def test_faostat_top_producers_cacao(self):
        ...
        try:
            response = self.session.get(
                f"{self.base_url}/production/faostat/top-producers/Cacao", timeout=TIMEOUT
            )
    ...
    def test_faostat_commodities(self):
        ...
        try:
            response = self.session.get(
                f"{self.base_url}/production/faostat/commodities", timeout=TIMEOUT
            )
            ...
            if response.status_code == 200:
                ...
                self.log_result(
                    ...
                    f"Liste des commodités agricoles validée - {len(commodities)} commodités",
                    {
                        ...
                        "sample_commodities": (
                            commodities[:5] if len(commodities) >= 5 else commodities
                        ),
                    },
                )
    ...
    def test_faostat_fisheries(self):
        ...
        try:
            response = self.session.get(
                f"{self.base_url}/production/faostat/fisheries", timeout=TIMEOUT
            )
    ...
    def test_unido_statistics(self):
        ...
        try:
            response = self.session.get(
                f"{self.base_url}/production/unido/statistics", timeout=TIMEOUT
            )
            ...
            if response.status_code == 200:
                ...
                self.log_result(
                    ...
                    {"total_countries": stats["total_countries"], "total_mva_bln_usd": actual_mva},
                )
    ...
    def test_unido_country_mar(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if missing_fields:
                    self.log_result(
                        "UNIDO MAR", False, f"Champs manquants: {missing_fields}", {"data": data}
                    )
                    return
    ...
    def test_unido_country_zaf(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if missing_fields:
                    self.log_result(
                        "UNIDO ZAF", False, f"Champs manquants: {missing_fields}", {"data": data}
                    )
                    return
                ...
                self.log_result(
                    ...
                    {"country_name": data["country_name"], "top_sectors": data["top_sectors"]},
                )
    ...
    def test_unido_ranking(self):
        ...
        try:
            response = self.session.get(
                f"{self.base_url}/production/unido/ranking", timeout=TIMEOUT
            )
            ...
            if response.status_code == 200:
                ...
                self.log_result(
                    ...
                    {"countries_count": len(ranking), "top_5": top_countries},
                )
    ...
    def test_unido_sector_analysis(self):
        ...
        try:
            response = self.session.get(
                f"{self.base_url}/production/unido/sector-analysis/10", timeout=TIMEOUT
            )
    ...
    def test_unido_isic_sectors(self):
        ...
        try:
            response = self.session.get(
                f"{self.base_url}/production/unido/isic-sectors", timeout=TIMEOUT
            )
            ...
            if response.status_code == 200:
                ...
                self.log_result(
                    ...
                    {"sectors_count": len(sectors), "sample_codes": list(sectors.keys())[:10]},
                )
