...
from engine.import_charges import aggregate_overall_status, calculate_import_charges, validate_quality_dimensions
...
def test_missing_base_tariff_is_blocked_and_total_is_withheld():
    result = calculate_import_charges(importing_country="DZA", exporting_country="MAR", hs6="010101", customs_value=100, calculation_date=date(2025, 1, 1), regional_coverage_complete=True, national_coverage_complete=True)
...
def test_present_but_unverified_base_is_simulation_only():
    result = calculate_import_charges(importing_country="DZA", exporting_country="MAR", hs6="010101", customs_value=100, calculation_date=date(2025, 1, 1), base_rate=10, base_rate_status="AVAILABLE_UNVERIFIED", regional_coverage_complete=True, national_coverage_complete=True)
...
def test_verified_base_with_missing_national_layer_is_partial():
    result = calculate_import_charges(importing_country="DZA", exporting_country="MAR", hs6="010101", customs_value=100, calculation_date=date(2025, 1, 1), base_rate=10, base_rate_status="SOURCE_ARCHIVED", base_source_id="DZA-TARIFF", base_hs_version="HS2022", base_effective_from="2025-01-01", regional_coverage_complete=True, national_coverage_complete=False)
    assert result["calculation_status"] == "INFORMATIVE_PARTIAL"
...
def test_complete_result_exposes_component_provenance():
    result = calculate_import_charges(importing_country="DZA", exporting_country="MAR", hs6="010101", customs_value=100, calculation_date=date(2025, 1, 1), base_rate=10, base_rate_status="SOURCE_ARCHIVED", base_source_id="DZA-TARIFF-2025", base_source_hash="a" * 64, base_hs_version="HS2022", base_effective_from="2025-01-01", importer_profile={"source_authority": "DGD", "source_title": "Tarif officiel archivé"}, regional_coverage_complete=True, national_coverage_complete=True)
...
def test_complete_result_is_informative_and_non_binding():
    result = calculate_import_charges(
        importing_country="DZA", exporting_country="MAR", hs6="010101", customs_value=100,
        calculation_date=date(2025, 1, 1), base_rate=10, base_rate_status="SOURCE_ARCHIVED",
        base_source_id="DZA-TARIFF-2025", base_source_hash="a" * 64,
        base_hs_version="HS2022", base_effective_from="2025-01-01",
...
def test_missing_effective_date_is_partial_temporality():
    result = calculate_import_charges(
        importing_country="DZA", exporting_country="MAR", hs6="010101", customs_value=100,
        base_rate=10, base_rate_status="SOURCE_ARCHIVED", base_source_id="DZA-TARIFF",
        base_source_hash="a" * 64, base_hs_version="HS2022",
        regional_coverage_complete=True, national_coverage_complete=True,
    )
...
def test_internal_source_id_alone_is_not_documented():
    result = calculate_import_charges(
        importing_country="DZA", exporting_country="MAR", hs6="010101", customs_value=100,
        base_rate=10, base_rate_status="SOURCE_ARCHIVED", base_source_id="INTERNAL-TARIFF",
        base_hs_version="HS2022", base_effective_from="2025-01-01",
        regional_coverage_complete=True, national_coverage_complete=True,
    )
...
def test_missing_fiscal_component_prevents_informative_complete():
    result = calculate_import_charges(
        importing_country="DZA", exporting_country="MAR", hs6="010101", customs_value=100,
        base_rate=10, base_rate_status="SOURCE_ARCHIVED", base_source_id="DZA-TARIFF-2025",
        base_source_hash="a" * 64, base_hs_version="HS2022", base_effective_from="2025-01-01",
        regional_coverage_complete=True, national_coverage_complete=True,
        national_taxes=[{"country_iso3": "DZA", "code": "VAT", "rate_pct": 19,
                         "effective_from": "2025-01-01", "source_id": "VAT-1",
...
def test_overall_status_unavailable_for_missing_base_or_indispensable_dimension():
    assert aggregate_overall_status(QUALITY_DIMENSIONS, base_available=False) == "CALCULATION_UNAVAILABLE"
