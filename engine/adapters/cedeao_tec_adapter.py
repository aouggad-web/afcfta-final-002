...
VERIFY_NOTE = (
    "Taxe nationale hors TEC — taux standard usuel, à confirmer "
...
COLUMN_ALIASES = {
    ...
    "unit": {"unite", "unit", "su", "uniteStatistique".lower(), "us", "statisticalunit"},
    ...
    def _measures(
        ...
        if country in UEMOA:
            add(
                ...
                rate_pct=0.8,
                sequence=26,
                legal_reference="Acte additionnel UEMOA (taux porté de " "0,5 % à 0,8 % en 2017)",
                observation=VERIFY_NOTE,
            )
...
if __name__ == "__main__":
    ...
    ap.add_argument("--version-date", default=None, help="Millésime du TEC (YYYY-MM-DD)")
    args = ap.parse_args()
