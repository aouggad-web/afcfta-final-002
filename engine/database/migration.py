...
class PostgresQueryService:
    ...
    def get_by_national_code(self, iso3: str, national_code: str) -> Optional[Dict]:
        ...
        try:
            commodity = (
                ...
                .filter_by(country_iso3=iso3.upper(), national_code=national_code)
                .first()
            )
    ...
    def get_by_hs6(self, iso3: str, hs6: str) -> List[Dict]:
        ...
        try:
            commodities = (
                session.query(Commodity).filter_by(country_iso3=iso3.upper(), hs6=hs6).all()
            )
    ...
    def get_statistics(self, iso3: str) -> Dict:
        ...
        try:
            ...
            stats = (
                ...
                .filter_by(country_iso3=iso3.upper())
                .first()
            )
